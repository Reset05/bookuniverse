        ...
        <div class="container container-filter_product">
            ...
            <?php
                ...
                foreach ($products as $product) {
                    ...
                    // Отображение товара
                    echo    '<div class="cards__block">';
                    echo    '<img id="card-img" src="../img/card/'.$product['img'] . '">';
                    echo    '<h3 class="card-title"><a style="color: black;" href="../pages/product.phtml?id='. $product['id'].'">'. $product['name'].'</a></h3>';
                    echo    '<p><i class="fa-regular fa-star"></i>'.$product['rating'].'</p>';
                    echo    '<p id="price" class="price">'.$product['price'].'</p>';
                    
                    echo    '<a href="?cart=add&id='. $product['id'].'" class="btn__buy add-to-cart" data-id="'. $product['id'].'">Купить</a>';
                    echo    '</div>';
                }
